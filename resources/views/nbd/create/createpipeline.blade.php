                  ...
                  <div class="col-10 col-md-8 col-lg-6">
                    ...
                    <form action="{{ route('nbd.storepipeline') }}" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="estimated_spend" name="estimated_spend" autocomplete="off">
                      </div>
                      <br/>
                      ...
                      <div class="form-group custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" name="site_survey" id="site_survey">
                        <label class="custom-control-label" for="site_survey">Site Survey</label>
                      </div>
                      <br/>
