                    ...
                    <form action="{{ route('nbd.storeconversion') }}" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="annual_opp_volume" name="annual_opp_volume" min="0" placeholder="25,000" autocomplete="off">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-primary">Create Conversion</button>
                    </form>
                  </div>
                </div>
              </div>
